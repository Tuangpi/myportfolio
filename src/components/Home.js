      ...
      <div className="flex flex-col-reverse mt-8 items-center justify-center lg:flex-row">
        <div className="">
          ...
          <p className="w-9/12 cursor-default text-gray-800 m-auto mb-8 text-center lg:text-left lg:m-0 tracking-tight">
            ...
            <div className="-mt-4">
              <FontAwesomeIcon icon={faHandshake} className="text-orange-800" />{" "}
              Let's work together to create a professional and functional web
              presence for your business or personal brand.<FontAwesomeIcon icon={faHandshake} className="text-yellow-800" />
            </div>
          </p>
          <Link
            to="/contact"
        ...
        <img
          src={hero}
          alt="Hero"
          className="w-80 h-80 rounded-full bg-slate-500 shadow-lg shadow-orange-900"
        />
      </div>
    </>
  );
